...
async function main() {
  ...
  const schemaBigInt = "5092705718192257135499521678642337856";

  const type = "KYCAgeCredential";
  const schemaUrl = "ipfs://QmReTXkPt5Dkdx2ytefcPnWBtF8hNznjmhvSmkufjwfpDq";
  // merklized path to field in the W3C credential according to JSONLD  schema e.g. birthday in the KYCAgeCredential under the url "https://raw.githubusercontent.com/iden3/claim-schema-vocab/main/schemas/json-ld/kyc-v3.json-ld"
  const schemaClaimPathKey =
    "4102980088128760873417934162852388610350338891271561653843337878864957831290";

  const requestId = 1702161919;
  ...
  const query = {
    ...
    slotIndex: 0,
    value: [20, ...new Array(63).fill(0)], // for operators 1-3 only first value matters
  ...
  const ERC20VerifierAddress = "0xe42dc7367d2CAD83dE053b1463aA858a0C94C659";
